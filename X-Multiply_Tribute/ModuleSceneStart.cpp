...
{
	if ((App->input->keyboard[SDL_SCANCODE_1] == KEY_DOWN || App->input->controller_START_button == KEY_STATE::KEY_DOWN) && App->ui->coins > 0) App->fade->FadeToBlack(this, App->stage1, 2);
